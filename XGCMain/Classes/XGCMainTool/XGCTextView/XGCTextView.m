...
@interface XGCTextView ()<UITextViewDelegate>
@property (nonatomic, strong) UILabel *placeholderLabel;
@end

@implementation XGCTextView
...
- (void)UITextViewTextDidChange:(id)sender {
    ...
    XGCTextView *textView = nil;
    if ([sender isKindOfClass:[NSNotification class]]) {
        textView = ((NSNotification *)sender).object;
    } else if ([sender isKindOfClass:[XGCTextView class]]) {
        textView = (XGCTextView *)sender;
    }
    if (![textView isKindOfClass:[XGCTextView class]]) {
        return;
    }
