...
@interface XGCTextField ()
/// 代理着
@property (nonatomic, strong) XGCTextFieldDelegator *delegator;
@end

@implementation XGCTextField
...
- (void)_didInitialize {
    self.delegator = [[XGCTextFieldDelegator alloc] init];
