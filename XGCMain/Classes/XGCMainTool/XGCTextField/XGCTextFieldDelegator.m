...
@implementation XGCTextFieldDelegator

- (BOOL)textField:(XGCTextField *)textField shouldChangeCharactersInRange:(NSRange)range replacementString:(NSString *)string {
    if (textField.markedTextRange) {
        return YES;
    }
    if (![textField isKindOfClass:[XGCTextField class]]) {
        return YES;
    }
